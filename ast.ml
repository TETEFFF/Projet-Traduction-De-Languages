...
(* Type affectable qui représente soit une variable soit la valeur pointée par un pointeur  *)
type affectable = 
...
type expression =
  ...
  (* Valeur du pointeur nul *)
  | Null 
  (* Création d'un nouveau pointeur sur un certain type *)
  | New of typ 
