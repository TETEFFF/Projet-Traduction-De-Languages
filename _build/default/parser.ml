...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState093 : (('s, _menhir_box_main) _menhir_cell1_aff, _menhir_box_main) _menhir_state
    (** State 093.
        Stack shape : aff.
        Start symbol: main. *)
...
include struct
  ...
  and _menhir_run_094 : type  ttv_stack. (ttv_stack, _menhir_box_main) _menhir_cell1_aff -> _ -> _ -> _ -> _ -> _menhir_box_main =
